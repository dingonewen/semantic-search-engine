...
// Defines the Request struct and some free functions that parse raw HTTP text into usable data
// e.g. GET /query?terms=hello+world HTTP/1.1
// in spec it assumes clients send legal HTTP/1.1 request
struct Request {
